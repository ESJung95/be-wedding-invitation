...
/**
 * Authorization scope:
 * - /api/admin/login is public (issues the token).
 * - /api/admin/**   requires a valid admin JWT.
 * - /api/invitation/** is public; it is protected by the per-guest token in the URL,
 *   not by JWT.
 */
@Configuration
@EnableWebSecurity
